...
function [new_generation, numSurvivors] = replacement3(individuals, k, pm, change, selectionMode, m, iteration, training, expected, gName, capas, n1, secondSelectionMode, parentsFitness, replacementCriteria, secondReplacementMode, crossMode, pc)
